...
pkgname=e-booster-um-git
pkgver=1.7.1.r0.gce49e8c
pkgrel=1
pkgdesc="Booster UKI Manager - A simple bash script to manage UKI files generated by booster and eukify"
url="https://github.com/thePrivacyFanatic/${pkgname%-*}"
arch=('any')
