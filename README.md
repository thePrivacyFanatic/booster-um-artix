# e-booster-um
this is a systemd-free fork for [Zile995/booster-um](https://github.com/Zile995/booster-um)
The script was designed for artix linux.
 ...
 * Required:
   ...
   * go-yq - Parse booster and e-booster-um configs
...
```bash
git clone https://github.com/thePrivacyFanatic/e-booster-um.git
cd e-booster-um
makepkg -si
```
...
* e-booster-um libalpm hooks by default:
...
* `egummiboot` will, if installed as a bootloader, detect UKI files generated by `booster-um`. For more information about booting, see the [Unified kernel image - Booting](https://wiki.archlinux.org/title/Unified_kernel_image#Booting) article
